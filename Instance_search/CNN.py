...
if __name__ == '__main__':
    ...
    # Directories
    query_feat_dir = '/content/drive/MyDrive/4186/2/query_features/'
    query_img_dir = '/content/drive/MyDrive/4186/query_img_4186/'
    gallery_feat_dir = '/content/drive/MyDrive/4186/2/gallery_features/'
    gallery_img_dir = '/content/drive/MyDrive/4186/gallery_4186/'
